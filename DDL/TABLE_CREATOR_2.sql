...
CREATE TABLE SUPPLY_REQUESTS ( REQUEST_ID NUMBER, PLACEMENT_DATE DATE DEFAULT SYSDATE, DEADLINE DATE, CONSTRAINT SR_PK PRIMARY KEY ( REQUEST_ID ) );
...
CREATE TABLE LOGS ( LOG_ID NUMBER GENERATED ALWAYS AS IDENTITY, TIMESTAMP_COL TIMESTAMP DEFAULT CURRENT_TIMESTAMP, LOG_MESSAGE VARCHAR2 ( 255 ), CONSTRAINT LOG_PK PRIMARY KEY ( LOG_ID ) );
